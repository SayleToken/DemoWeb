...
export class FuseContactsContactListComponent implements OnInit, OnDestroy
{
    ...
    displayedColumns = ['checkbox',  'customer', 'product', 'quantity', 'amount'];
    ...
    constructor(
        private contactsService: TransactionsService,
    ...
    )
    {
        ...
        this.onUserDataChangedSubscription =
            this.contactsService.ontransactionDataChanged.subscribe(user => {
                this.user = user;
            });
...
{
    constructor(private contactsService: TransactionsService)
    {
        super();
    }
