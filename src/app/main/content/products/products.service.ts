...
export class productsService implements Resolve<any>
{
    ...
    {
        return new Promise((resolve, reject) => {
                this.http.get('http://ec2-18-220-64-6.us-east-2.compute.amazonaws.com:3000/api/products')
    ...
    createContact(contact)
    {
        return new Promise((resolve, reject) => {
            ...
            this.http.post('http://ec2-18-220-64-6.us-east-2.compute.amazonaws.com:3000/api/products/', {...contact})
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
    ...
    updateContact(contact)
    {
        return new Promise((resolve, reject) => {
            ...
            this.http.put('http://ec2-18-220-64-6.us-east-2.compute.amazonaws.com:3000/api/products/', {...contact})
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
