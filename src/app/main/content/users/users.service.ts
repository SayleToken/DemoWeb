...
export class UsersService implements Resolve<any>
{
    ...
    {
        return new Promise((resolve, reject) => {
                this.http.get('http://ec2-34-245-47-221.eu-west-1.compute.amazonaws.com:3000/api/users')
    ...
    createContact(contact)
    {
        return new Promise((resolve, reject) => {
            ...
            this.http.post('http://ec2-34-245-47-221.eu-west-1.compute.amazonaws.com:3000/api/users/', {...contact})
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
    ...
    updateContact(contact)
    {
        return new Promise((resolve, reject) => {
            ...
            this.http.put('http://ec2-34-245-47-221.eu-west-1.compute.amazonaws.com:3000/api/users/', {...contact})
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
